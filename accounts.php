 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item ">  <a class="nav-link" href="transfer.php">Funds Transfer1</a></li>
     <li class=" btn btn-outline-primary">  <a href="" data-toggle="tooltip"  ><?php echo $userData['name']; ?></a></li>
