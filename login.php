...
<body style="background: url(images/bank0.jpg);background-size: 100%">
...
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 222px" >
  ...
  <div class="card rounded-0">
    ...
    <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       <form method="POST">
       	<input type="email" value="user@gmail.com" name="email" class="form-control" required placeholder="Enter Email">
