  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item ">  <a class="nav-link" href="transfer.php">Funds Transfer</a></li>
       <li class="nav-item ">  <a href="" class="btn btn-outline-primary" data-toggle="tooltip" title="Name" ><?php echo $userData['name']; ?></a></li>
...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welecome to Nalanchira Bank</h4>
